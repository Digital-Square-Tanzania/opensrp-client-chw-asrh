...
import org.smartregister.chw.asrh_sample.R;
...
public class EntryActivity extends SecuredActivity implements View.OnClickListener, BaseAsrhVisitContract.VisitView {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.asrh_activity).setOnClickListener(this);
        findViewById(R.id.asrh_home_visit).setOnClickListener(this);
        findViewById(R.id.asrh_profile).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.asrh_activity:
                startActivity(new Intent(this, AsrhRegisterActivity.class));
                break;
            case R.id.asrh_home_visit:
                AsrhVisitActivity.startMe(this, "12345", false);
                break;
            case R.id.asrh_profile:
                AsrhMemberProfileActivity.startMe(this, "12345");
                break;
            default:
                break;
        }
