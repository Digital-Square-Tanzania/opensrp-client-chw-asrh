...
public class BaseAsrhRegisterPresenterTestLibrary {
    ...
    @Mock
    protected AsrhRegisterContract.Interactor interactor;
    @Mock
    protected AsrhRegisterContract.Model model;
    @Mock
    protected AsrhRegisterContract.View baseView;
    private BaseAsrhRegisterPresenter presenter;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        presenter = new BaseAsrhRegisterPresenter(baseView, model, interactor);
    }
    ...
    public void getViewWhenViewIsNull() throws Exception {
        Assert.assertNull(Whitebox.invokeMethod(baseAsrhRegisterPresenter, "getView"));
    }
