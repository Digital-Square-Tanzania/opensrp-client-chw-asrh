package org.smartregister.chw.asrh.provider;
...
public class AsrhRegisterProvider implements RecyclerViewProvider<AsrhRegisterProvider.RegisterViewHolder> {
    ...
    private String updateMemberGender(CommonPersonObjectClient commonPersonObjectClient) {
        ...
        return AsrhUtil.getGenderTranslated(context, gender);
    ...
    private void populatePatientColumn(CommonPersonObjectClient pc, final RegisterViewHolder viewHolder) {
        try {
            ...
            viewHolder.patientColumn.setTag(R.id.VIEW_ID, BaseAsrhRegisterFragment.CLICK_VIEW_NORMAL);

            viewHolder.dueButton.setTag(pc);
            viewHolder.dueButton.setTag(R.id.VIEW_ID, BaseAsrhRegisterFragment.FOLLOW_UP_VISIT);
...
//        implement
    ...
    public RegisterViewHolder createViewHolder(ViewGroup parent) {
        View view = inflater.inflate(R.layout.asrh_register_list_row, parent, false);
