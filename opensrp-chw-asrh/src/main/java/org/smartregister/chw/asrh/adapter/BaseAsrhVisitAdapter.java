package org.smartregister.chw.asrh.adapter;
...
public class BaseAsrhVisitAdapter extends RecyclerView.Adapter<BaseAsrhVisitAdapter.MyViewHolder> {
    private Map<String, BaseAsrhVisitAction> pmtctHomeVisitActionList;
    private Context context;
    private BaseAsrhVisitContract.View visitContractView;

    public BaseAsrhVisitAdapter(Context context, BaseAsrhVisitContract.View view, LinkedHashMap<String, BaseAsrhVisitAction> myDataset) {
    ...
    @NotNull
    @Override
    public BaseAsrhVisitAdapter.MyViewHolder onCreateViewHolder(@NotNull ViewGroup parent,
                                                                int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.asrh_visit_item, parent, false);
     ...
     * @return
     */
    private BaseAsrhVisitAction getByPosition(int position) {
        int count = -1;
        for (Map.Entry<String, BaseAsrhVisitAction> entry : pmtctHomeVisitActionList.entrySet()) {
    ...
    public void onBindViewHolder(@NotNull MyViewHolder holder, int position) {
        ...
        BaseAsrhVisitAction sbcVisitAction = getByPosition(position);
        ...
        if (StringUtils.isNotBlank(sbcVisitAction.getSubTitle())) {
            ...
            if (sbcVisitAction.isEnabled()) {
                ...
                boolean isOverdue = sbcVisitAction.getScheduleStatus() == BaseAsrhVisitAction.ScheduleStatus.OVERDUE &&
    ...
    private int getCircleColor(BaseAsrhVisitAction sbcVisitAction) {
    ...
    private void bindClickListener(View view, final BaseAsrhVisitAction pmtctHomeVisitAction) {
