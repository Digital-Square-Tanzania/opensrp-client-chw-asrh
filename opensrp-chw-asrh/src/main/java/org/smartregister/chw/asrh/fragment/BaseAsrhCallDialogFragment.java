...
import org.smartregister.chw.asrh.listener.BaseAsrhCallWidgetDialogListener;
import org.smartregister.chw.asrh.R;
import org.smartregister.chw.asrh.domain.MemberObject;

public class BaseAsrhCallDialogFragment extends DialogFragment implements BaseAsrhCallDialogContract.View {
    ...
    public static BaseAsrhCallDialogFragment launchDialog(Activity activity, MemberObject MO) {
        BaseAsrhCallDialogFragment dialogFragment = BaseAsrhCallDialogFragment.newInstance();
    ...
    public static BaseAsrhCallDialogFragment newInstance() {
        return new BaseAsrhCallDialogFragment();
    }
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ViewGroup dialogView = (ViewGroup) inflater.inflate(R.layout.asrh_member_call_widget_dialog_fragment, container, false);
        setUpPosition();
        if (listener == null) {
            listener = new BaseAsrhCallWidgetDialogListener(this);
        }
    ...
    private void initUI(ViewGroup rootView) {
        if (StringUtils.isNotBlank(MEMBER_OBJECT.getPhoneNumber())) {
            ...
            if (StringUtils.isNotBlank(MEMBER_OBJECT.getFamilyHead())) {
                TextView familyHeadName = rootView.findViewById(R.id.asrh_call_head_name);
                familyHeadName.setText(MEMBER_OBJECT.getFamilyHeadName());
                TextView clientCallHeadPhone = rootView.findViewById(R.id.asrh_call_head_phone);
                ...
                rootView.findViewById(R.id.asrh_layout_family_head).setVisibility(GONE);
            }

            if (!MEMBER_OBJECT.getBaseEntityId().equals(MEMBER_OBJECT.getFamilyHead())) {
                //just a member
                TextView malariaClientNameTextView = rootView.findViewById(R.id.call_asrh_client_name);
                ...
                setCallTitle(rootView, R.id.call_asrh_client_title, "");
                TextView callMalariaClientPhone = rootView.findViewById(R.id.call_asrh_client_phone);
                ...
                rootView.findViewById(R.id.layout_asrh_client).setVisibility(GONE);
            }
        }

        rootView.findViewById(R.id.asrh_call_close).setOnClickListener(listener);
    }
    ...
    @Override
    public void setPendingCallRequest(BaseAsrhCallDialogContract.Dialer dialer) {
