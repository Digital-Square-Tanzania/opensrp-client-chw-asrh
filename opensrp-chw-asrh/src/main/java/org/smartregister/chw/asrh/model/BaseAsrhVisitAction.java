...
import org.smartregister.chw.asrh.fragment.BaseHomeVisitFragment;
 ...
 */
public class BaseAsrhVisitAction {
    ...
    private AsrhVisitActionHelper asrhVisitActionHelper;
    private final Map<String, List<VisitDetail>> details;
    private final Context context;
    private final Validator validator;

    private BaseAsrhVisitAction(Builder builder) throws ValidationException {
        ...
        this.asrhVisitActionHelper = builder.asrhVisitActionHelper;
    ...
    private void initialize() {
        try {
            ...
            if (asrhVisitActionHelper != null) {
                asrhVisitActionHelper.onJsonFormLoaded(jsonPayload, context, details);
                String pre_processed = asrhVisitActionHelper.getPreProcessed();
                ...
                String sub_title = asrhVisitActionHelper.getPreProcessedSubTitle();
                if (StringUtils.isNotBlank(sub_title)) {
                    this.subTitle = sub_title;
                }

                ScheduleStatus status = asrhVisitActionHelper.getPreProcessedStatus();
                if (status != null) {
    ...
    private void onPayloadReceivedNotifyHelper(String jsonPayload) {
        ...
        asrhVisitActionHelper.onPayloadReceived(jsonPayload);

        String sub_title = asrhVisitActionHelper.evaluateSubTitle();
        if (sub_title != null) {
            setSubTitle(sub_title);
        }

        String post_process = asrhVisitActionHelper.postProcess(jsonPayload);
        if (post_process != null) {
            this.jsonPayload = asrhVisitActionHelper.postProcess(jsonPayload);
        }

        asrhVisitActionHelper.onPayloadReceived(this);
    }
    ...
    public AsrhVisitActionHelper getAsrhVisitActionHelper() {
        return asrhVisitActionHelper;
    }

    public void setAsrhVisitActionHelper(AsrhVisitActionHelper asrhVisitActionHelper) {
        this.asrhVisitActionHelper = asrhVisitActionHelper;
    }
    ...
    public void evaluateStatus() {
        ...
        if (getAsrhVisitActionHelper() != null) {
            setActionStatus(getAsrhVisitActionHelper().evaluateStatusOnPayload());
        }
    }

    public BaseAsrhVisitAction.Status computedStatus() {
    ...
    public interface AsrhVisitActionHelper {
         ...
         */
        void onPayloadReceived(BaseAsrhVisitAction baseAsrhVisitAction);
    }
    ...
    public static class Builder {
        ...
        public Builder withHelper(AsrhVisitActionHelper asrhVisitActionHelper) {
            this.asrhVisitActionHelper = asrhVisitActionHelper;
            return this;
        }
        ...
        public BaseAsrhVisitAction build() throws ValidationException {
            return new BaseAsrhVisitAction(this);
        }
    }
