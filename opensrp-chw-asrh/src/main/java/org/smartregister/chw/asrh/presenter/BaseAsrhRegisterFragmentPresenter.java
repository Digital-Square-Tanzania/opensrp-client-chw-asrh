...
public class BaseAsrhRegisterFragmentPresenter implements AsrhRegisterFragmentContract.Presenter {

    protected WeakReference<AsrhRegisterFragmentContract.View> viewReference;
    ...
    public BaseAsrhRegisterFragmentPresenter(AsrhRegisterFragmentContract.View view, AsrhRegisterFragmentContract.Model model, String viewConfigurationIdentifier) {
    ...
    protected AsrhRegisterFragmentContract.View getView() {
